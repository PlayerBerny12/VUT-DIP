...
\projectinfo{
  ...
  keywords.cs={deepfake, framework, detekce deepfake, kontejnerizace, webový doplňek}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={deepfake, framework, deepfake detection, containerazation, web plugin}, % klíčová slova v anglickém jazyce / keywords in english
